...
list(APPEND DEPENDENCIES_FOR_SHARED_LIB ${SFML_DEPS})
list(APPEND DEPENDENCIES_FOR_STATIC_LIB ${SFML_DEPS})
list(APPEND DEPENDENCIES_FOR_STATIC_PROFILE_LIB ${SFML_DEPS}) # only use for static profiling profile
